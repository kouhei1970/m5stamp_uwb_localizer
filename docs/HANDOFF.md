# 次セッションへの申し送り (2026-08-21 時点 / §0-A のみ 2026-08-28 追記)

**このファイルを最初に読むこと。** 全体像・決定事項・落とし穴・次の一手をまとめてある。

**§1 以降は 2026-08-21 時点の記述で、2026-08-27〜28 の実機セッションより前のものである。**
測距が成立しない件の現在地は下の **§0-A** が正本。

---

## 0-A. 最優先: SS/DS-TWR がほぼ成立しない件（2026-08-28）
