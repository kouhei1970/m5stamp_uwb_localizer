...
**分からない略語が出たら [GLOSSARY.md](GLOSSARY.md)、単位で混乱したら [UNITS.md](UNITS.md)。**

### 🔧 B. 買った。動かしたい

```
GETTING_STARTED.md  →  EXPERIMENT_PLAN.md  →  BRINGUP.md
...
> **⚠ 配線前に [SOLDER_PADS.md](SOLDER_PADS.md) と
...
| `*Uus` の単位で混乱した | [UNITS.md](UNITS.md) |
| **とにかく実機に書き込みたい** | [PREBUILT_BINARIES.md](PREBUILT_BINARIES.md) |
| Device ID が読めない | [BRINGUP.md](BRINGUP.md) §切り分け、[GETTING_STARTED.md §4.3](GETTING_STARTED.md#probe-troubleshoot) |
